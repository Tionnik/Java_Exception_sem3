...
public class requestUser {
    ...
    public static String nameData(){
        ...
        System.out.println();
        System.out.print("Введите свои данные через пробел, на латинице, в вввиде: \n"+
        "         Фамилия Имя Отчество датарождения номертелефона пол(f/m)\n"+
        "Пример: Градунов Сергей Игнатович 17.12.1987 88002002117 m\n");
        ...
        else {System.out.println("Указана дата будужего дня, что недопустимо"); return "-1"; }
